...
| [quarterly_close](quarterly_close.md) | End of quarter | ~2 hr | `/munawara-quarter-plan` → cross-domain `/shura-brainstorm` → KABIR_SHERBO pillar check |
| [annual_close](annual_close.md) | Late December | ~4–6 hr | `/kabir-sherbo-annual-review` → `/shura-emerge` 365d → HIKMAH crystallization → 10/15/20-yr refresh |
...
| [onboarding_first_7_days](onboarding_first_7_days.md) | First-time POP user | Gentle 7-day on-ramp, daily morning habit first |
