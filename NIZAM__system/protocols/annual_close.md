...
- **Skills chained**: `/kabir-sherbo-annual-review` → `/shura-emerge` → HIKMAH learning capture → optional 10/15/20-yr refresh
...
### Step 1 — `/kabir-sherbo-annual-review` (~90 min)
...
Write to `KABIR_SHERBO__long_horizon_strategy/reviews/annual/{YYYY}_annual_review.md`.
...
Re-read KABIR_SHERBO 10-yr / 15-yr / 20-yr plans. Are they still credible? Update non-negotiables, alliances, decisive battles where evidence warrants.
...
## Output
- 1 annual review in `KABIR_SHERBO/reviews/annual/`
- 1 year-emerge SHURA session
- 3–10 new HIKMAH entries
- Updated KABIR_SHERBO 10/15/20-yr plans (if evidence warrants)
