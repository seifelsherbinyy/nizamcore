...
> Plan the next quarter. Cross-domain SHURA. TARIQ pillar sanity check.

## Frontmatter
- **Cadence**: end of Q1 / Q2 / Q3 / Q4
- **Budget**: ~2 hours total (split across 2 sessions if SUKOON yellow)
- **Gates checked**: SUKOON, THABAT
- **Skills chained**: `/munawara-quarter-plan` → cross-domain `/shura-brainstorm` → TARIQ pillar check
...
- Rolls up to: 1_year objective + 3_year + TARIQ pillar reference.
...
### Step 4 — TARIQ pillar sanity check (~15 min)
For each of 3–5 strategic pillars in active TARIQ horizons:
...
- Updated TARIQ pillar scorecards (in 10_year/15_year files)
