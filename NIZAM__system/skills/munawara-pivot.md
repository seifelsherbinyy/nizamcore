...
target_folder: KABIR_SHERBO__long_horizon_strategy/major_pivots/
...
1. Identify which KABIR_SHERBO or MUNAWARA plans this pivot affects. List with `[[wikilinks]]`.
...
5. Write the pivot record at `KABIR_SHERBO__long_horizon_strategy/major_pivots/pivot_{YYYY-MM-DD}__{slug}.md`.
